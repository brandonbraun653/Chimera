 ...
 */
  ...
  namespace Array
  {
    ...
    References:
        1.
    https://stackoverflow.com/questions/14279821/cast-an-stdarray-to-another-data-type-at-compile-time
        2.
    https://stackoverflow.com/questions/31463388/can-someone-please-explain-the-indices-trick
    -------------------------------------------------*/
     ...
     * works on more complex types. Given that Chimera is an embedded systems
