...
*       would be nearly every non-volatile form of memory storage on the market.
*
...
namespace Chimera
{
    namespace Modules
    {
        namespace Memory
        {
            ...
            *   dual-maintained with BDEVOPENMODE found in redosserv.h from the Reliance Edge FS.
            */
            ...
            public:
                ...
                *   Initializes a disk
                *
                *   @param[in]  volNum          The volume number of the volume who is being opened
                *   @return BlockStatus
                */
                ...
                *
                *   @param[in]  volNum          The volume number of the volume who is being closed
                *   @return BlockStatus
                */
                ...
                *
                *   @param[in]  volNum          The volume number of the volume whose block device is being read from
                ...
                *   @return BlockStatus
                */
                virtual BlockStatus DiskRead(const uint8_t volNum, const uint64_t sectorStart, const uint32_t sectorCount, void *const readBuffer) = 0;

                /**
                *   Write sectors to a disk
                *
                *   @param[in]  volNum          The volume number of the volume whose block device is being written to
                *   @param[in]  sectorStart     The starting sector number
                *   @param[in]  sectorCount     The number of sectors to write
                *   @param[in]  writeBuffer     The buffer from which to write the sector data
                *   @return BlockStatus
                */
                virtual BlockStatus DiskWrite(const uint8_t volNum, const uint64_t sectorStart, const uint32_t sectorCount, const void *const writeBuffer) = 0;

                /**
                *   Flush any caches beneath the file system
                *
                *   @param[in]  volNum          The volume number of the volume whose block device is being flushed
                *   @return BlockStatus
                */
