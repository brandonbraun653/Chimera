...
namespace Chimera::Threading
{
  ...
  Lockable::Lockable()
  {
    mutex = createSyncObject<RecursiveTimedMutex>();
  }

  Lockable::~Lockable()
  {
    destroySyncObject( mutex );
  }

  Chimera::Status_t Lockable::lock( const size_t timeout_mS )
  {
    auto pass = Chimera::CommonStatusCodes::OK;
    auto fail = Chimera::CommonStatusCodes::FAIL;
    return ( ::Chimera::Threading::lock( mutex, timeout_mS ) ? pass : fail );
  }
  ...
  Chimera::Status_t Lockable::lockFromISR( const size_t timeout_mS )
  {
    auto pass = Chimera::CommonStatusCodes::OK;
    auto fail = Chimera::CommonStatusCodes::FAIL;
    return ( ::Chimera::Threading::lockFromISR( mutex ) ? pass : fail );
  }
  ...
  Chimera::Status_t Lockable::unlock()
  {
    auto pass = Chimera::CommonStatusCodes::OK;
    auto fail = Chimera::CommonStatusCodes::FAIL;
    return ( ::Chimera::Threading::unlock( mutex ) ? pass : fail );
  }
  ...
  Chimera::Status_t Lockable::unlockFromISR()
  {
    auto pass = Chimera::CommonStatusCodes::OK;
    auto fail = Chimera::CommonStatusCodes::FAIL;
    return ( ::Chimera::Threading::unlockFromISR( mutex ) ? pass : fail );
  }
