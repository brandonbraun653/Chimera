...
namespace Chimera
{
	namespace Logging
	{
		...
		/** An extremely simple logging class that directly writes a console through printf(). 
		 *	The only features are to colorize the output and include a logging level tag. Other than that,
		 *	it is simply just plain'ol printf().
		 **/
		class SimpleLogger
		{
		public:
